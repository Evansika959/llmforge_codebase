...
```bash
caffeinate -i python -u -m scripts.prediction active run \
  --workspace scripts/prediction/outputs/active_learning_watch5_dynamic_under45 \
...
```bash
caffeinate -i python -u -m scripts.prediction active step \
