...
Extends the repo's existing `llmforge_bridge/prove_parity.sh` discipline (PyTorch golden
...
Usage:
  ...
  # then: diff c_tflite.txt <(python llmforge_bridge/ref_dump.py <ckpt_dir> ids.txt 64)
