...
def main():
    ...
    parser.add_argument('--results', type=Path, default=OUTPUTS/'proposed_physics_surrogate_936')
    args = parser.parse_args()
    out = args.results
    meta = json.loads((out / 'metadata.json').read_text())
    original = json.loads((OUTPUTS/'surrogate_comparison_936/metadata.json').read_text())
    ...
    with (SWEEP_CONFIGS/'watch5_random_1000_50M_150M_sweep.csv').open() as f:
