...
def main():
    ...
    lines += ['', '## Interpretation limits', '',
              ...
              '', '## Reproduce', '', '```bash', 
              'python -m llmforge.hw.device.prediction compare-surrogates --output runs/device/surrogate_comparison_repeat',
              'python -m llmforge.hw.device.prediction report-surrogates runs/device/surrogate_comparison_repeat', '```', '',
