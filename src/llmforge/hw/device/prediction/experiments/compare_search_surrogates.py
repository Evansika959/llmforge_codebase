...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--output',default=str(OUTPUTS/'architecture_search_models_936'))
    ...
    lines+=['','## Definitions and restrictions','',
        ...
        '', '## Reproduce','', '```bash',
        'python -m llmforge.hw.device.prediction compare-search-surrogates --output runs/device/architecture_search_models_repeat','```']
