...
from ..config import OUTPUTS, PREDICTION_ROOT, SWEEP_CONFIGS, SWEEP_OUTPUTS, FEATURES, TARGETS
...
def main():
    ...
    parser.add_argument('--output', default=str(OUTPUTS/'surrogate_comparison_936'))
