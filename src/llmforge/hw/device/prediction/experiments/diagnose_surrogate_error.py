...
def main():
    ...
    parser.add_argument('--output',default=str(OUTPUTS/'xgboost_error_diagnosis_936'))
    args=parser.parse_args()
    out=Path(args.output); out.mkdir(parents=True,exist_ok=False)
    prior=OUTPUTS/'surrogate_comparison_936'
    ...
    with (SWEEP_CONFIGS/'watch5_random_1000_50M_150M_sweep.csv').open() as f: configs={r['config_id']:r for r in csv.DictReader(f)}
